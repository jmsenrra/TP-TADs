...
\tadOperacion{tocando}{posición /p, conj(posición) /ps}{conj(posición)}{}
*da las posiciones a la derecha, izquierda, arriba y abajo de p que estan en el conjunto ps
...
\tadOperacion{ConvertirEnHippiesR}{posición /p, conj(posición) /estudiantes, conj(posición) /hippies}{tupla(conj(posición), conj(posición))}{}
*devuelve: tupla(conj(posición), conj(posición)) \newline
*devuelve estudiantes y hippies
\tadOperacion{ConvertirEnEstudiantesR}{posición /p, conj(posición) /estudiantes, conj(posición) /hippies, conj(posición) /obstáculos}{tupla(conj(posición), conj(posición))}{}
*devuelve: tupla(conj(posición), conj(posición)) \newline
*devuelve estudiantes y hippies
\tadOperacion{CapturarR}{posición /p, conj(posición) /estudiantes, conj(posición) /hippies, dicc(posición,agente) agentes, conj(posición) /obstaculos}{tupla(conj(posición),conj(posición),dicc(posición,agente))}{}
*devuelve: tupla(conj(posición),conj(posición),dicc(posición,agente)) \newline
*devuelve estudiantes, hippies y agentes
\tadOperacion{Capturar}{tupla(conj(posición),conj(posición)) /tuplaEstudiantesYHippies, dicc(posición,agente) /agentes, conj(posición) /obstaculos}{tupla(conj(posición),conj(posición),dicc(posición,agente))}{}
*devuelve: tupla(conj(posición),conj(posición),dicc(posición,agente)) \newline
*devuelve estudiantes, hippies y agentes
\tadOperacion{ConvertirEnEstudiantes}{tupla(conj(posición),conj(posición)) /tuplaEstudiantesYHippies, conj(posición) /obstaculos}{tupla(conj(posición),conj(posición))}{}
*devuelve: tupla(conj(posición), conj(posición)) \newline
*devuelve estudiantes y hippies
\tadOperacion{ConvertirEnHippies}{conj(posición) /estudiantes, conj(posición) hippies}{tupla(conj(posición),conj(posición))}{}
*devuelve: tupla(conj(posición), conj(posición)) \newline
*devuelve estudiantes y hippies
\tadOperacion{ENuevo}{campus /c, posición p}{ tupla(conj(posición),conj(posición),dicc(posición,agente))}{R3}
*devuelve: tupla(conj(posición),conj(posición),dicc(posición,agente)) \newline
*devuelve estudiantes, hippies y agentes
\tadOperacion{HNuevo}{campus /c, posición /p}{ tupla(conj(posición),conj(posición),dicc(posición,agente))}{R3}
*devuelve: tupla(conj(posición),conj(posición),dicc(posición,agente)) \newline
*devuelve estudiantes, hippies y agentes
\tadOperacion{EMovido}{campus /c, posición /p1, posición /p2}{ tupla(conj(posición),conj(posición),dicc(posición,agente))}{$1 \leq \pi_1(p2) \wedge \pi_1(p2) \leq ancho(mapa(c)) \wedge 1 \leq \pi_2(p2) \wedge \pi_2(p2) \leq alto(mapa(c)) \wedge p2 \notin obstaculos(mapa(c)) \wedge p2 \notin estudiantes(c) \wedge p2 \notin hippies(c) \wedge p2 \notin claves(agentes(c)) \wedge p1 \in estudiantes(c)$}
*devuelve: tupla(conj(posición),conj(posición),dicc(posición,agente)) \newline
*devuelve estudiantes, hippies y agentes
\tadOperacion{HMovido}{campus /c, posición /p1, posición /p2}{tupla(conj(posición),conj(posición),dicc(posición,agente))}{$1 \leq \pi_1(p2) \wedge \pi_1(p2) \leq ancho(mapa(c)) \wedge 1 \leq \pi_2(p2) \wedge \pi_2(p2) \leq alto(mapa(c)) \wedge p2 \notin obstaculos(mapa(c)) \wedge p2 \notin estudiantes(c) \wedge p2 \notin hippies(c) \wedge p2 \notin claves(agentes(c)) \wedge p1 \in hippies(c)$}
*devuelve: tupla(conj(posición),conj(posición),dicc(posición,agente)) \newline
*devuelve estudiantes, hippies y agentes
\tadOperacion{AMovido}{campus /c, posición /p1, posición /p2}{tupla(conj(posición),conj(posición),dicc(posición,agente))}{$1 \leq \pi_1(p2) \wedge \pi_1(p2) \leq ancho(mapa(c)) \wedge 1 \leq \pi_2(p2) \wedge \pi_2(p2) \leq alto(mapa(c)) \wedge p2 \notin obstaculos(mapa(c)) \wedge p2 \notin estudiantes(c) \wedge p2 \notin hippies(c) \wedge p2 \notin claves(agentes(c)) \wedge p1 \in claves(agentes((c)))$}
*devuelve: tupla(conj(posición),conj(posición),dicc(posición,agente)) \newline
*devuelve estudiantes, hippies y agentes
