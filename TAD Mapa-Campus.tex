...
\tadGeneradores
\tadOperacion{nuevoMapa}{nat /al, nat /an,conj(tupla(nat, nat)/obstaculos}{map}{(al $\geq$ 1) $\land$ (an $\geq$ 1) $\land$ (\paratodo{tupla(nat,nat)}{o}) (o $\in$ obstaculos $\implies$ (1 $\leq$ $\pi_1$(o) $\leq$ an $\land$ \newline 1 $\leq$ $\pi_2$(o) $\leq$ al))}
