...
*devuelve: tupla(conj(posición), conj(posición)) \newline
*devuelve estudiantes y hippies
\tadOperacion{eNuevo}{campus /c, posición p}{ tupla(conj(posición),conj(posición),dicc(posición,agente))}{$(\pi_2(p) = 1 \vee \pi_2(p) = alto(mapa(c))) \wedge 1 \leq \pi_1(p) \wedge \pi_1(p) \leq ancho(mapa(c)) \wedge p \notin obstaculos(mapa(c)) \wedge p \notin estudiantes(c) \wedge p \notin hippies(c) \wedge p \notin claves(agentes(c))$}
*devuelve: tupla(conj(posición),conj(posición),dicc(posición,agente)) \newline
*devuelve estudiantes, hippies y agentes
\tadOperacion{hNuevo}{campus /c, posición p}{ tupla(conj(posición),conj(posición),dicc(posición,agente))}{$(\pi_2(p) = 1 \vee \pi_2(p) = alto(mapa(c))) \wedge 1 \leq \pi_1(p) \wedge \pi_1(p) \leq ancho(mapa(c)) \wedge p \notin obstaculos(mapa(c)) \wedge p \notin estudiantes(c) \wedge p \notin hippies(c) \wedge p \notin claves(agentes(c))$}
*devuelve: tupla(conj(posición),conj(posición),dicc(posición,agente)) \newline
*devuelve estudiantes, hippies y agentes
