...
\tadGeneradores
\tadOperacion{nuevoMapa}{nat /al, nat /an,conj(tupla(nat, nat)/obstaculos}{map}{$ (al \geq 1) \land(an \geq 1) \land (\forall \hspace{0,1cm} o:\hspace{0,1cm}tupla(nat\hspace{0,1cm} , \hspace{0,1cm}nat)) \hspace{0,1cm} (o \in obstaculos \iff (1 \leq \pi_1(o)\leq an \land 1 \leq \pi_2(o)\leq al)) $ }
...
\tadAxioma{EstáArriba?($\pi_1$,p2)}{$\pi_1$(p1) = $\pi_1$(p2) $\land$ $\pi_2$(p1) > $\pi_2$(p2)}
\tadAxioma{EstáAbajo?($\pi_1$,p2)}{$\pi_1$(p1) = $\pi_1$(p2) $\land$ $\pi_2$(p1) < $\pi_2$(p2)}
\tadAxioma{EstáALaDerecha?($\pi_1$,p2)}{$\pi_1$(p1) > $\pi_1$(p2) $\land$ $\pi_2$(p1) = $\pi_2$(p2)}
\tadAxioma{EstáALaIzquierda?($\pi_1$,p2)}{$\pi_1$(p1) < $\pi_1$(p2) $\land$ $\pi_2$(p1) = $\pi_2$(p2)}
\tadAxioma{EstáEnLaPrimerDiagonal?($\pi_1$,p2)}{$\pi_1$(p1) > $\pi_1$(p2) $\land$ $\pi_2$(p1) > $\pi_2$(p2)}
\tadAxioma{EstáEnLaSegundaDiagonal?($\pi_1$,p2)}{$\pi_1$(p1) < $\pi_1$(p2) $\land$ $\pi_2$(p1) > $\pi_2$(p2)}
\tadAxioma{EstáEnLaTerceraDiagonal?($\pi_1$,p2)}{$\pi_1$(p1) < $\pi_1$(p2) $\land$ $\pi_2$(p1) < $\pi_2$(p2)}
\tadAxioma{EstáEnLaCuartaDiagonal?($\pi_1$,p2)}{$\pi_1$(p1) > $\pi_1$(p2) $\land$ $\pi_2$(p1) < $\pi_2$(p2)}
